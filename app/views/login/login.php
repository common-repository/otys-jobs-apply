...
<div class="login-form">
    <form action="<?php echo esc_url($args['action']); ?>" name="otys-login-form" method="POST" class="rest-form" id="login-form-<?php echo esc_attr($args['identifier']); ?>">
        ...
        <div class="form-footer">
            <?php if ($args['forgot_password_url']) { ?>
                <a href="<?php echo $args['forgot_password_url']; ?>">
                    <?php echo __('Forgot password', 'otys-jobs-apply'); ?>
                </a>
            <?php } ?>
